...
def build_llm_runtime_config() -> LlmRuntimeConfig:
    ...
    requested_mode = _env_value("SKILLGUARD_LLM_MODE").value.lower() or "auto"
    model_env = _first_env("SKILLGUARD_LLM_MODEL", "OPENAI_MODEL", "ANTHROPIC_MODEL", "LLM_MODEL")
    base_url_env = _first_env("SKILLGUARD_LLM_BASE_URL", "OPENAI_BASE_URL", "PACKY_API_URL", "ANTHROPIC_BASE_URL")
    ...
    codex_cli_env = _first_env("SKILLGUARD_CODEX_CLI")
    claude_cli_env = _first_env("SKILLGUARD_CLAUDE_CLI")
    timeout_env = _first_env("SKILLGUARD_LLM_TIMEOUT_SEC")
    ...
    return LlmRuntimeConfig(
        ...
        api_provider=api_provider,
        resolved_env={
            "mode": "SKILLGUARD_LLM_MODE" if os.environ.get("SKILLGUARD_LLM_MODE") else None,
...
def describe_llm_runtime(config: LlmRuntimeConfig | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "environment_variables": {
            "selection": ["SKILLGUARD_LLM_MODE", "SKILLGUARD_LLM_MODEL", "SKILLGUARD_LLM_TIMEOUT_SEC"],
            "local_cli": ["SKILLGUARD_CODEX_CLI", "SKILLGUARD_CLAUDE_CLI"],
            "online_api": [
...
def _invoke_codex_cli(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="skillguard-codex-") as tmp_dir:
